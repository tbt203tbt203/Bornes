...
@Service
public class Borne818 {

    public static String getBorne818(String borneNumber) throws IOException {
        try {
            URL url = new URL("https://api.charge.re/public/1/chargecontroller/818/?format=json");
