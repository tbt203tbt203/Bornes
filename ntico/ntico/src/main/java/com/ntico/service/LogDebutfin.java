...
public class LogDebutfin {
        ...
        @Autowired
        private static BornesRepository bornesRepository;

        public static String getBornedebutfinBddTableLog(String borneNumber) throws IOException {
            try {
